...
library(gtsummary) # so create nice summary tables
```
...
Now, instead, let's look compare ever smokers and never smokers just among the **lowest propensity score quintile**:
```{r}
nmes_data %>%
...
5. Submission notes:
    * Submit your assignment in R Markdown through Github by Sunday (February 13, 2022) at midnight. You can find a link to create this assignment in Github on Blackboard.
