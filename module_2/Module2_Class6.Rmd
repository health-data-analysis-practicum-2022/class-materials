...
* Submit your data display(s) and the code for your updated survey-weighted analysis in R Markdown through Github by Sunday March 13, 2022 at midnight.
...
**Note:** This is often an iterative process whether you decide on a question, look for data, and then realize you need to refine or modify your question based on available data.
...
* It can be helpful to gram your question in terms of investigating a relationship between a specific outcome variable (like "disease status" from our Module 1) and one or more primary predictor variables ("smoking status" from our Module 1.)
